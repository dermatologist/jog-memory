...
Welcome to `jog-memory` contributor's guide.
...
If you experience bugs or general issues with `jog-memory`, please have a look
...
You can help improve `jog-memory` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jog-memory` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jog-memory`'s files. While this mechanism can
...
```
conda create -n jog-memory python=3 six virtualenv pytest pytest-cov
conda activate jog-memory
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jog-memory.git
   cd jog-memory
   ```
...
5. Install [pre-commit]:
   ...
   `jog-memory` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jog-memory
[issue tracker]: https://github.com/<USERNAME>/jog-memory/issues
